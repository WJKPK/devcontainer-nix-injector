...
def validate_sources(ctx: typer.Context, param: click.Parameter, value: str) -> str:
    ...
    if param.name == "github" and ctx.params.get("repo") is None:
...
def setup_devcontainer(
    ...
    repo: str | None = typer.Option(
        ...
        "--repo",
        "-r",
        callback=lambda ctx, param, value: validate_sources(ctx, param, validate_url(value)),
    ...
    github: str | None = typer.Option(
        ...
        "--github",
        "-g",
        callback=lambda ctx, param, value: validate_sources(ctx, param, validate_github(value)),
